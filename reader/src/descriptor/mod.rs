...
mod tests {
    ...
    fn primitive_field_descriptor() {
        ...
        assert_eq!(
            *parse_field_descriptor("C").unwrap().field_type(),
            FieldType::BaseType(BaseType::Char)
        );
        assert_eq!(
            *parse_field_descriptor("D").unwrap().field_type(),
            FieldType::BaseType(BaseType::Double)
        );
        assert_eq!(
            *parse_field_descriptor("F").unwrap().field_type(),
            FieldType::BaseType(BaseType::Float)
        );
        assert_eq!(
            *parse_field_descriptor("I").unwrap().field_type(),
        ...
        assert_eq!(
            *parse_field_descriptor("S").unwrap().field_type(),
    ...
    fn object_field_descriptor() {
        let object = ObjectType::new(ClassName::new(vec![
            UnqualifiedName::new("java"),
            UnqualifiedName::new("lang"),
            UnqualifiedName::new("Object"),
        ]));
    ...
    fn array_field_descriptor() {
        ...
        assert_eq!(
            *parse_field_descriptor("[Ljava/lang/Object;")
                .unwrap()
                .field_type(),
            FieldType::ArrayType(ArrayType::new(FieldType::ObjectType(object)))
        );
        assert_eq!(
            *parse_field_descriptor("[Ljava/lang/String;")
                .unwrap()
                .field_type(),
            FieldType::ArrayType(ArrayType::new(FieldType::ObjectType(string)))
        );
        assert_eq!(
            *parse_field_descriptor("[B").unwrap().field_type(),
