...
xstore_n!(lstore_0, Long, 0);
xstore_n!(lstore_1, Long, 1);
xstore_n!(lstore_2, Long, 2);
xstore_n!(lstore_3, Long, 3);
...
xstore_n!(dstore_0, Double, 0);
xstore_n!(dstore_1, Double, 1);
xstore_n!(dstore_2, Double, 2);
xstore_n!(dstore_3, Double, 3);
