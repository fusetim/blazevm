...
use crate::{
    alloc::{Array, ArrayRef, ObjectRef},
    class::ConstantValue,
};
...
impl Slot {
    ...
    pub fn default_for(td: &FieldType) -> Slot {
        match td {
            ...
            &FieldType::ObjectType(_) | &FieldType::ArrayType(_) => Slot::UndefinedReference,
        }
    }

    pub fn is_reference(&self) -> bool {
        match self {
            Slot::ArrayReference(_) | Slot::ObjectReference(_) | Slot::UndefinedReference => true,
            _ => false,
        }
    }
}
